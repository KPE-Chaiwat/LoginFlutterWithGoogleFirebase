...
import 'package:tot_tot/forgot_password.dart';
import 'package:tot_tot/home.dart';
import 'package:tot_tot/signup.dart';
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                     ...
                     AuthMethods().signInWithApple(scopes: [Scope.email, Scope.fullName]);
                  // AuthMethods().  appleSign(context);
                    },
                    child: Image.asset(
                      "images/apple1.png",
                      height: 50,
